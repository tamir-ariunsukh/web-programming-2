...
//
// Тэмдэглэл: useEffect бол 4-р долоо хоногийн сэдэв. Зөвхөн энэ туслах компонентод
// ашиглаж байна — labs/ доторх дасгалууд 3-р долоо хоногийн хүрээндээ хэвээр.
        ...
        (editing ? (
          <>
            ...
            <p className="code-hint">
              ...
              Ажиллах бүрд жишээ эхнээс эхэлнэ (төлөв шинээр үүснэ).
            </p>
          </>
        ) : (
          <pre className="code">
